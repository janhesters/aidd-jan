...
/**
 * Converts a headers object to a plain object for testing purposes.
 *
 * NOTE: This is a helper function for testing purposes only. We need this
 * function because test frameworks can't directly compare Headers objects.
 * The casing of header names is preserved as returned by the Headers API.
 *
 * @param headers - A Headers object.
 * @returns A plain object containing the headers.
 */
